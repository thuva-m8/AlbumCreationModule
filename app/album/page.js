                    ...
                    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        <div className="flex justify-end">
                            ...
                            <Link href="album/create-album">
                                <button
                                    type="submit"
                                    className="inline-flex justify-center px-3.5 py-2 border border-blue-200 bg-blue-50 text-sm rounded-md text-blue-700 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-100"
                                >
