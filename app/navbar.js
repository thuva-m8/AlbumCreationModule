                        ...
                        <div className="pt-2 pb-4 space-y-1">
                            {
                                navigation.map((item) => {
                                    ...
                                    return (
                                        <div key={item.name}
                                             className='border-blue-500 text-blue-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium'>
                                            <a
                                                key={item.name}
                                                href={item.href}
                                                className={isActive ? 'border-indigo-500 text-blue-700' : 'border-transparent text-gray-500  hover:text-gray-700 hover:border-gray-300'}
                                            >
                                                {item.name}
                                            </a>
                                        </div>
